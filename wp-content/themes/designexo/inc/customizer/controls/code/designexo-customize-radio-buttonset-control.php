...
/**
 * Class Designexo_Customize_Radio_Buttonset_Control
 */
class Designexo_Customize_Radio_Buttonset_Control extends Designexo_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'designexo-radio-buttonset';
