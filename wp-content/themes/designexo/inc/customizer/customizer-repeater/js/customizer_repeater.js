...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-designexo_main_slider_content')
		{	
			var numItems = jQuery("#customize-control-designexo_main_slider_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 2){ 
			  jQuery( "#customize-control-designexo_slider_upgrade .designexo-upgrade-pro-message" ).show();
			  return false;   
			}
		}
		if(parentid == 'customize-control-designexo_theme_info_content')
		{
			var numItems = jQuery("#customize-control-designexo_theme_info_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 4){ 
			  jQuery( "#customize-control-designexo_theme_info_upgrade .designexo-upgrade-pro-message" ).show();
			  return false;   
			}
		}
		if(parentid == 'customize-control-designexo_project_content')
		{
			var numItems = jQuery("#customize-control-designexo_project_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 4){ 
			  jQuery( "#customize-control-designexo_project_upgrade .designexo-upgrade-pro-message" ).show();
			  return false;   
			}
		}
		if(parentid == 'customize-control-designexo_testimonial_content')
		{
			var numItems = jQuery("#customize-control-designexo_testimonial_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 3){ 
			   jQuery( "#customize-control-designexo_testimonial_upgrade .designexo-upgrade-pro-message" ).show();
			  return false;   
			}
		}	
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var main_slider_items = jQuery("#customize-control-designexo_main_slider_content .customizer-repeater-general-control-repeater-container").length 
				if(main_slider_items < 3){ 
				  jQuery( "#customize-control-designexo_slider_upgrade .designexo-upgrade-pro-message" ).hide();
				}
				
				
				var theme_info_items = jQuery("#customize-control-designexo_theme_info_content .customizer-repeater-general-control-repeater-container").length 
				if(theme_info_items < 5){ 
				  jQuery( "#customize-control-designexo_theme_info_upgrade .designexo-upgrade-pro-message" ).hide();
				}
				var project_items = jQuery("#customize-control-designexo_project_content .customizer-repeater-general-control-repeater-container").length 
				if(project_items < 5){ 
				  jQuery( "#customize-control-designexo_project_upgrade .designexo-upgrade-pro-message" ).hide(); 
				}
				var testimonial_items = jQuery("#customize-control-designexo_testimonial_content .customizer-repeater-general-control-repeater-container").length 
				if(testimonial_items < 4){ 
				   jQuery( "#customize-control-designexo_testimonial_upgrade .designexo-upgrade-pro-message" ).hide();  
				}			
